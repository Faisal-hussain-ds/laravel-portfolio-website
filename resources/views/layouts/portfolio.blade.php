            ...
            <div class="left-side">
              ...
              <div class="right-side">
                  <div class="main active">
                      ...
                      <div class="input-text">
                          <div class="input-div">
                              ...
                              <input type="text" autoComplete="off" class="form-control" name="first_name" required require id="user_name">
                          
                          </div>
                          <div class="input-div"> 
                            <label><b>Last Name</b></label>
                              <input type="text"  name="last_name" required require>
                      ...
                      <div class="input-text">
                          ...
                          <div class="input-div">
                            <label><b>Email Address</b></label>
                              <input type="text"  name="email" value="{{Auth::user()->email??''}}" required require >
                  ...
                  <div class="main">
                      ...
                      <div class="input-text">
                          ...
                          <label><b>Registration Number</b></label>
                              <input type="text" name="reg_number" required  require>
                  ...
                  <div class="main">
                      ...
                      <div class="input-text">
                          <div class="input-div">
                            <label><b>Internship Theme</b></label> 
                              <input type="text" name="internship_theme" required require>
                              <span></span>
                          </div>
                      ...
                      <div class="input-text">
                          <div class="input-div">
                              <label><b>Padagogical Manager</b></label>  
                              <input type="text" name="padagogical_manager" required require>
